...
#define NVIC_ISER0							*((volatile uint32_t*)	NVIC_BASE_ADDERESS + 0x000)
#define NVIC_ISER1							*((volatile uint32_t*)	NVIC_BASE_ADDERESS + 0x004)
#define NVIC_ISER2							*((volatile uint32_t*)	NVIC_BASE_ADDERESS + 0x008)
#define NVIC_ICER0							*((volatile uint32_t*)	NVIC_BASE_ADDERESS + 0x080)
#define NVIC_ICER1							*((volatile uint32_t*)	NVIC_BASE_ADDERESS + 0x084)
#define NVIC_ICER2							*((volatile uint32_t*)	NVIC_BASE_ADDERESS + 0x088)
